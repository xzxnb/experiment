...
def MLN_TV(mln1: str,mln2: str, w1, w2, w3, w4, w5) -> [float, float, float]:
    ...
    for key in count_dist4:
        w = w1 ** key[0] * w2 ** key[1] * w2 ** key[2] * w3**key[3] / Z1
...
if __name__ == '__main__':
    ...
    weight1 = [0.5*(i+1) for i in range(200)]
    w1 = create_vars("w1")
    w2 = create_vars("w2")
    w3 = create_vars("w3")
    w4 = create_vars("w4")
